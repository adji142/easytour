							...
							<ul class="nav flex-column">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" data-bs-toggle="collapse"  href="javascript:void(0)" data-bs-target="#Master" role="button" aria-expanded="false" aria-controls="Master">
                                        ...
                                        <span class="nav-text">Landing Page Setting</span>
                                ...
                                <div class="collapse nav-collapse" id="Master" data-bs-parent="#accordion">
                                    <div id="accordion1">
                                        <ul class="nav flex-column">
                                            <li class="nav-item">
                                                <a href="{{ route('topservices') }}" class="nav-link sub-nav-link">
                                                    <span class="svg-icon nav-icon d-flex justify-content-center">
                                                        <svg xmlns="http://www.w3.org/2000/svg" width="10px" height="10px" fill="currentColor" class="bi bi-circle" viewBox="0 0 16 16">
                                                            <path fill-rule="evenodd" d="M8 15A7 7 0 1 0 8 1a7 7 0 0 0 0 14zm0 1A8 8 0 1 0 8 0a8 8 0 0 0 0 16z"/>
                                                          </svg>
                                                    </span>
                                                    <span class="nav-text">Top Services</span>
                                                </a>
                                            </li>

											<li class="nav-item">
                                                <a href="{{ route('easytoursetting') }}" class="nav-link sub-nav-link">
                                                    <span class="svg-icon nav-icon d-flex justify-content-center">
                                                        <svg xmlns="http://www.w3.org/2000/svg" width="10px" height="10px" fill="currentColor" class="bi bi-circle" viewBox="0 0 16 16">
                                                            <path fill-rule="evenodd" d="M8 15A7 7 0 1 0 8 1a7 7 0 0 0 0 14zm0 1A8 8 0 1 0 8 0a8 8 0 0 0 0 16z"/>
                                                          </svg>
                                                    </span>
                                                    <span class="nav-text">Easy Tour Setting</span>
                                                </a>
                                            </li>

											<li class="nav-item">
                                                <a href="{{ route('testimonial') }}" class="nav-link sub-nav-link">
                                                    <span class="svg-icon nav-icon d-flex justify-content-center">
                                                        <svg xmlns="http://www.w3.org/2000/svg" width="10px" height="10px" fill="currentColor" class="bi bi-circle" viewBox="0 0 16 16">
                                                            <path fill-rule="evenodd" d="M8 15A7 7 0 1 0 8 1a7 7 0 0 0 0 14zm0 1A8 8 0 1 0 8 0a8 8 0 0 0 0 16z"/>
                                                          </svg>
											...
											<li class="nav-item">
                                                <a href="{{ route('bestpartner') }}" class="nav-link sub-nav-link">
                                                    <span class="svg-icon nav-icon d-flex justify-content-center">
                                                        <svg xmlns="http://www.w3.org/2000/svg" width="10px" height="10px" fill="currentColor" class="bi bi-circle" viewBox="0 0 16 16">
                                                            <path fill-rule="evenodd" d="M8 15A7 7 0 1 0 8 1a7 7 0 0 0 0 14zm0 1A8 8 0 1 0 8 0a8 8 0 0 0 0 16z"/>
                                                          </svg>
                                                    </span>
                                                    <span class="nav-text">Best Partner</span>
                                                </a>
                                            </li>
                                        ...
                                        <ul class="nav flex-column">
											...
											<li class="nav-item">
                                                <a href="#" class="nav-link sub-nav-link">
                                                    ...
                                                    <span class="nav-text">Privacy Police</span>
                                                </a>
                                            </li>
								...
								<li class="nav-item">
                                    <a class="nav-link" data-bs-toggle="collapse"  href="javascript:void(0)" data-bs-target="#FrontPage" role="button" aria-expanded="false" aria-controls="FrontPage">
                                        <span class="svg-icon nav-icon">
                                            <i class="fas fa-boxes font-size-h4"></i>
                                        </span>
                                ...
                                <div class="collapse nav-collapse" id="FrontPage" data-bs-parent="#accordion">
                                    <div id="accordion1">
                                        <ul class="nav flex-column">
                                            <li class="nav-item">
                                                <a href="#" class="nav-link sub-nav-link">
                                                    ...
                                                    <span class="nav-text">Top Destionation</span>
                                                </a>
                                            </li>
											...
											<li class="nav-item">
                                                <a href="#" class="nav-link sub-nav-link">
                                                    ...
                                                    <span class="nav-text">Top Hotels</span>
                                                </a>
                                            </li>
