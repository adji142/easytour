							...
							<div class="card-body" >
                            	...
                            	@endif
	                            	...
	                            	<div class="form-group row">
	                            		<div class="col-md-12">
	                            			<label  class="text-body">Kode Hotel</label>
	                            		...
	                            		<div class="col-md-12">
	                            			<label  class="text-body">Nama Hotel</label>
	                            			<fieldset class="form-group mb-3">
	                            				<input type="text" class="form-control" id="name" name="name" placeholder="Masukan Nama Hotel" value="{{ count($hotel) > 0 ? $hotel[0]['name'] : '' }}" required="">
	                            			</fieldset>
	                            		...
	                            		<div class="col-md-12">
	                            			...
	                            			<fieldset class="form-group mb-3">
	                            				<input type="mail" class="form-control" id="email" name="email" placeholder="Masukan Email Hotel" value="{{ count($hotel) > 0 ? $hotel[0]['email'] : '' }}" required="">
	                            			</fieldset>
	                            			...
	                            			<fieldset class="form-group mb-3">
	                            				<select name="KelompokAkses" id="KelompokAkses" class="js-example-basic-single js-states form-control bg-transparent" name="state" required="">
													...
													@foreach($rolesdata as $ko)
														<option 
                                                            value="{{ $ko->id }}"
                                                            {{ count($hotel) > 0 ? $hotel[0]['KelompokAkses'] == $ko->id ? "selected" : '' :""}}
                                                        >
                                                            {{ $ko->RoleName }}
                                                        </option>
													@endforeach
	                            		...
	                            		<div class="col-md-6">
	                            			...
	                            			<fieldset class="form-group mb-3">
	                            				<select name="Active" id="Active" class="js-example-basic-single js-states form-control bg-transparent" name="state" >
													<option value="Y" {{ count($hotel) > 0 ? $hotel[0]['Active'] == 'Y' ? "selected" : '' :""}}>Active</option>
													<option value="N" {{ count($hotel) > 0 ? $hotel[0]['Active'] == 'N' ? "selected" : '' :""}}>Tidak Active</option>
												</select>
	                            			</fieldset>
