<template>
    ...
    <!-- News Area -->
    <NewsArea :article="article" :articleLastest="articleLastest" :articleCount="articleCount"/>
...
import NewsArea from '@/components/NewsAreaDetail.vue'
...
export default {
    name: "NewsView",
    components: {
        Header,TopDestinationBanner, NewsArea, Footer
    },
    props:{
