                        ...
                        <div class="tour_detail_right_sidebar">
                            <div class="tour_details_right_boxed">
                                <div class="tour_details_right_box_heading">
                                    <h3>{{ oDataProdukPackage.HotelName }}</h3>
                                </div>
                                <div class="tour_package_details_bar_list">
                                    <h5>Package details</h5>
                                    <strong><p v-html="oDataProdukPackage.RoomName"></p></strong>
                                    <p><sub>Room Size <strong>{{ oDataProdukPackage.RoomSize }} m<sup>2</sup></strong></sub></p>
                                    <p><sub>Room Type <strong>{{ oDataProdukPackage.RoomTypeName }}</strong> </sub></p>
                                    <p><sub>Bed Type <strong>{{ oDataProdukPackage.BedTypeName }}</strong> </sub></p>
                                    <p v-html="oDataProdukPackage.RoomDescription"></p>
                                </div>
                                <div class="tour_package_details_bar_price">
                                    <h5>Price</h5>
                                    <div class="tour_package_bar_price">
                                        <h6 v-if="oDataProdukPackage.RoomDiscount > 0">
                                            <del> {{ formatNumber(oDataProdukPackage.RoomPrice) }}</del>
                                        </h6>
                                        <h3>
                                             {{ formatNumber(oDataProdukPackage.RoomDiscount > 0 ? oDataProdukPackage.RoomDiscount : oDataProdukPackage.RoomPrice) }}
                                            <sub>/Per person</sub>
                                        </h3>
                                    </div>
                                </div>
                    ...
                    <div class="tour_detail_right_sidebar">
                        <div class="tour_details_right_boxed">
                            ...
                            <div class="tour_booking_amount_area">
                                <ul>
                                    <li>Adult Price x {{ adult }} <span>{{ formatNumber(oDataProdukPackage.RoomPrice) }}</span></li>
                                </ul>
                                    ...
                                    <li>
                                        ...
                                        <span>
                                            -{{ discountPercent > 0 ? formatNumber(
                                                (oDataProdukPackage.RoomPrice - oDataProdukPackage.RoomDiscount) * adult
                                            ) : 0 }}
                                        </span>
                                    </li>
                                </ul>
...
export default {
    ...
    computed: {
        discountPercent() {
            const originalPrice = this.oDataProdukPackage.RoomPrice;
            const discountPrice = this.oDataProdukPackage.RoomDiscount;
        ...
        // Hitung subtotal
        subtotal() {
            const price = this.oDataProdukPackage.RoomPrice;
        ...
        discountAmount() {
            return this.oDataProdukPackage.RoomDiscount > 0 ?(this.oDataProdukPackage.RoomPrice - this.oDataProdukPackage.RoomDiscount)  : 0;
        },
        // Hitung pajak
        taxAmount() {
